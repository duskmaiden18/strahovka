...
class Updates:
    ...
    def parser(self):
        ...
        r = requests.post(
            'https://kis.bank.gov.ua/?__VIEWSTATE=%2FwEPDwUKMjA0NDA5OTAxN2RkYp6DC6WJ1c7OZ5ZQtR%2FzO%2BgjVTw%3D&p_EDRPOU=&p_REGNO=&p_FULLNAME=&p_IM_ST=%25null%25&p_IRL_FT=3&p_NFS=0&p_SVIDOTSTVO_SERIES=&p_SVIDOTSTVO_NO=&p_ACTDATE_FROM=&p_ACTDATE_TO=&p_ILD_NUMBER=&pagenum=1&btn_all=1&__VIEWSTATEGENERATOR=EC5CD28C', headers = headers)
